...
size_calibration.py -- calibration file for determining onion sizes 
"""
...
def calibrate(directory): 
    ...
    upper_white = np.array([30, 60, 255], dtype ="uint8")
            ...
            if imgpath.find(".ini") > -1:
                ...
                for c in cnts:
                    ...
                    if radius >= 100:
                        ...
                        print("radius =", radius)
                        # define and draw extremity points on the circle diameter
